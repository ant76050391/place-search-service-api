...
public class GlobalWebFilter implements WebFilter {
  ...
  private ServerWebExchange decorate(ServerWebExchange exchange, ByteArrayOutputStream reqBaos, ByteArrayOutputStream resBaos) {
   ...
   */
  private ServerHttpRequest mutateHeaderRequest(ServerHttpRequest request, HttpHeaders httpHeaders) {
